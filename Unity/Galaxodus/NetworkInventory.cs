...
/// <summary>
/// A NetworkInventory is a special type of inventory where the host manages everything to do with it. Any item requests must go through the host server and items can only be taken if the client
/// has a valid ItemTicket. This maintains a synchronised and unexploited (theoretically) inventory system. Supports the use of composition and being a native component.
/// </summary>
[System.Serializable] public sealed class NetworkInventory : MonoBehaviour
{
    ...
    {
        // Since this will be the main entry point of the GUI and will be called multiple times per frame a try-catch block is used instead of checking the the index each time.
        try
        {
    ...
    #endregion Getters, setters & properties
    ...
    #endregion Ticket validity request
    ...
    #endregion Remove item from server
